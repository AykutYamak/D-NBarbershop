...
public class BarberModelTests
{
    ...
    public void Barber_WithFirstNameLongerThan100Characters_ShouldFailValidation()
    {
        ...
        Assert.That(isValid.Equals(false), "Barber with FirstName longer than 100 characters should fail validation");
        Assert.That(1.Equals(validationResults.Count), "Should have one validation error");
        Assert.That(ErrorMessages.MaxLengthExceededErrorMessage(100).Equals(validationResults[0].ErrorMessage));
    }
